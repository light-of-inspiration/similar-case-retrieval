...
Unfortunately, the original baseline is inefficient, not structured, and not easy to understand with unstructured organisation.
...
(acc) E:\Py_Dev\IceBerg>conda list
